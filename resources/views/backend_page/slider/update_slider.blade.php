          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
             ...
             <!-- /.card-header -->
              ...
              <form id="quickForm" action="{{ route('update/slider',$slide->id) }}"  method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title1" value="{{$slide->title1}}" class="form-control @error('title1') is-invalid @enderror" id="name" placeholder="Title1" >
                    @error('title1')
                    <div class="alert alert-danger alert-dismissible fade show" style="padding:5px;" role="alert">
                        <strong>{{ $message }}</strong>
                        <button type="button" class="close" style="padding:5px; color:white !important;" data-dismiss="alert" aria-label="Close">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title2" value="{{$slide->title2}}" class="form-control @error('title2') is-invalid @enderror" id="name" placeholder="Title2" >
                    @error('title2')
                    <div class="alert alert-danger alert-dismissible fade show" style="padding:5px;" role="alert">
                        <strong>{{ $message }}</strong>
                        <button type="button" class="close" style="padding:5px; color:white !important;" data-dismiss="alert" aria-label="Close">
