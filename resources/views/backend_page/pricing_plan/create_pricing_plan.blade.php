        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Create Pricing Plan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
             ...
             <!-- /.card-header -->
              ...
              <form id="quickForm" action="{{ route('store/pricing_plan') }}"  method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <select name="plan_id" class="form-control select2" style="width: 100%;">
                                    @foreach ( $plan as $show )
                                      <option value="{{$show->id}}">{{$show->plan}}</option>
                                    @endforeach
                                </select>
                                @error('plan_id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="features_name" class="form-control @error('features_name') is-invalid @enderror" id="name" placeholder="Features Name" >
                                @error('features_name')
                                <div class="alert alert-danger alert-dismissible fade show" style="padding:5px;" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="close" style="padding:5px; color:white !important;" data-dismiss="alert" aria-label="Close">
