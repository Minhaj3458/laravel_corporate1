          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
             ...
             <!-- /.card-header -->
              ...
              <form id="quickForm" action="{{ route('store/about') }}"  method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="sub_title1" class="form-control @error('sub_title1') is-invalid @enderror" id="name" placeholder="Sub Title1" >
                                @error('sub_title1')
                                <div class="alert alert-danger alert-dismissible fade show" style="padding:5px;" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="close" style="padding:5px; color:white !important;" data-dismiss="alert" aria-label="Close">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="sub_title2" class="form-control @error('sub_title2') is-invalid @enderror" id="name" placeholder="Sub Title2" >
                                @error('sub_title2')
                                <div class="alert alert-danger alert-dismissible fade show" style="padding:5px;" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="close" style="padding:5px; color:white !important;" data-dismiss="alert" aria-label="Close">
                           ...
                           <div class="form-group">
                               ...
                               <input type="text" name="sub_title3" class="form-control @error('sub_title3') is-invalid @enderror" id="name" placeholder="Sub Title3" >
                                @error('sub_title3')
                                <div class="alert alert-danger alert-dismissible fade show" style="padding:5px;" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="close" style="padding:5px; color:white !important;" data-dismiss="alert" aria-label="Close">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="sub_title4" class="form-control @error('sub_title4') is-invalid @enderror" id="name" placeholder="Sub Title4" >
                                @error('sub_title4')
                                <div class="alert alert-danger alert-dismissible fade show" style="padding:5px;" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="close" style="padding:5px; color:white !important;" data-dismiss="alert" aria-label="Close">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="about" id="description" data-placeholder="Enter About Us" cols="4" rows="4" class="form-control @error('about') is-invalid @enderror" maxlength="300"></textarea>
                                @error('about')
                                <div class="alert alert-danger alert-dismissible fade show" style="padding:5px;" role="alert">
                                    <strong>{{ $message }}</strong>
                                    <button type="button" class="close" style="padding:5px; color:white !important;" data-dismiss="alert" aria-label="Close">
