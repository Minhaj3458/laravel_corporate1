          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
             ...
             <!-- /.card-header -->
              ...
              <form id="quickForm" action="{{ route('update/blog/category',$blog_cat->id) }}"  method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="name">Category Name</label>
                    <input type="text" name="category_name" value="{{  $blog_cat->category_name }}" class="form-control @error('category_name') is-invalid @enderror" id="name" placeholder="Category Name" >
                    @error('category_name')
