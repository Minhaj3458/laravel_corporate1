          ...
          <div class="col-md-8">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create Choose Us</h3>
              </div>
             <!-- /.card-header -->
              <!-- form start -->

              <form id="quickForm" action="{{ route('store/choose_us') }}"  method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
